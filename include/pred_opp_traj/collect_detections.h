#ifndef PRED_OPP_TRAJ__COLLECT_DETECTIONS_H_
#define PRED_OPP_TRAJ__COLLECT_DETECTIONS_H_
...
public:
    CollectDetection() {};
    CollectDetection(std::string map, std::string pkg_path);
    void init_detections(std::string map, std::string pkg_path);
    void add_detection(pred_msgs::msg::Detection detected_opp, double curr_time);
...
#endif  // PRED_OPP_TRAJ__COLLECT_DETECTIONS_H_
