#ifndef PRED_OPP_TRAJ__DETECTION_H_
#define PRED_OPP_TRAJ__DETECTION_H_
...
public:
    DetectionNode() {};
    DetectionNode(Track track);
    pred_msgs::msg::Detection detect(sensor_msgs::msg::LaserScan scan, nav_msgs::msg::Odometry ego_odom, nav_msgs::msg::Odometry opp_odom);
...
#endif  // PRED_OPP_TRAJ__DETECTION_H_