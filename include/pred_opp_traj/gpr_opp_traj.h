#ifndef PRED_OPP_TRAJ_CPP__GPR_OPP_TRAJ_H_
#define PRED_OPP_TRAJ_CPP__GPR_OPP_TRAJ_H_
...
class GPROppTrajNode : public rclcpp::Node
{
public:
    GPROppTrajNode();
...
#endif  // PRED_OPP_TRAJ_CPP__GPR_OPP_TRAJ_H_