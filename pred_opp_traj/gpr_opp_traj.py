...
class GPROppTraj(Node):
    def __init__(self):
        ...
        self.declare_parameter('dt', 0.04)
    ...
    def timer_callback(self):
        curr_time = time.time()
        if self.curr_opp != self.prev_opp and self.detection_array is not None:
            ...
            pred_time = np.arange(0, self.horizon * self.dt, self.dt) + 0.2
            ...
            for i in range(len(pred_x)):
                ...
                marker.color.r = pred_v[i] / 8.0
                marker.color.g = (abs(pred_v[i] / 8.0 - 0.4) - 0.4) * 2
                marker.color.b = 1.0 - pred_v[i] / 8.0
                marker.color.a = 1.0
                # marker.color.r = 0.0
                # marker.color.g = 1.0
                # marker.color.b = 0.0
            ...
            # for i in range(len(da_copy)):
            #     print("Detection", i, "DT:", da_copy[i].dt)
            # print('\n\n')
